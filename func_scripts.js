...
function addCivilServiceRow() {
  ...
  var ratingInput = createInputElement(
    "text",
    "civil_service_rating",
    "Rating (If applicable)"
  );

  // Create an input for Civil Service examination date
  var examDateInput = createInputElement(
    "date",
    "civil_service_examination_dates[]",
    ""
  );

  // Create an input for Civil Service place of examination
  var placeExamInput = createInputElement(
    "text",
    "civil_service_place_of_examination",
    "Place of Examination"
  );

  // Create an input for Civil Service license number
  var licenseNumInput = createInputElement(
    "number",
    "civil_service_license_num",
    "License Number"
  );

  // Create an input for Civil Service date of validity
  var dateValidityInput = createInputElement(
    "date",
    "civil_service_date_of_validity",
    ""
  );
...
function addExperienceRow() {
  ...
  var companyNameInput = createInputElement(
    "text",
    "company_names[]",
    "Company Name"
  );
  var monthlySalaryInput = createInputElement(
    "number",
    "monthly_salaries[]",
    "Monthly Salary"
  );
  var salaryGradeInput = createInputElement(
    "text",
    "salary_grades[]",
    "Salary Grade"
  );
  var statusAppointmentInput = createInputElement(
    "radio",
    "status_appointments[]",
    ""
  );
...
function addMoreWorkExperienceRow() {
  ...
  // Create input fields and textarea
  var organizationNameTextarea = createTextareaElement(
    "organization_names[]",
    "Name of Organization"
  );
  var organizationAddressTextarea = createTextareaElement(
    "organization_addresses[]",
    "Address of Organization"
  );
  var fromDateInput = createInputElement("date", "from_dates[]", "From");
  var toDateInput = createInputElement("date", "to_dates[]", "To");
  var hoursInput = createInputElement(
    "number",
    "number_of_hours[]",
    "Number of Hours"
  );
  var positionInput = createInputElement(
    "text",
    "positions[]",
...
function addMoreLearningDevelopmentRow() {
  ...
  var titleTextarea = createTextareaElement(
    "learning_titles[]",
  ...
  var conductedByTextarea = createTextareaElement(
    "ld_conducted_by[]",
...
function addOtherInformationRow() {
  ...
  // Create textarea
  var specialSkillsTextarea = createTextareaElement(
    "special_skills",
    "Special Skills and Hobbies"
  );
  var nonAcademicDistractionTextarea = createTextareaElement(
    "non_academic_distraction",
    "Non-Academic Distraction / Recognition"
  );
  var associationTextarea = createTextareaElement(
    "association_organization",
    "In Association / Organization"
  );
...
function addInformationRow() {
  ...
  var addressTextarea = createTextareaElement(
    "information_addresses[]",
    "Address"
  );
  var telNoTextarea = createTextareaElement(
    "information_tel_nos[]",
    "Tel. No."
  );
